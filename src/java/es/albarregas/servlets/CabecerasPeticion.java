 ...
 * @author Ricardo
 */
@WebServlet(name = "CabecerasPeticion", urlPatterns = {"/cabPet"})
public class CabecerasPeticion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<caption><h3>Cabeceras de petici&oacute;n</h3></caption>");
            ...
            while(cabeceras.hasMoreElements()){
                ...
                out.println("<tr><td>" +cabecera +"</td><td>" +request.getHeader(cabecera) +"</td></tr>");          
            }
            out.println("</table>");
